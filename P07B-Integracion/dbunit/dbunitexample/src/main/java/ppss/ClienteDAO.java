...
public class ClienteDAO implements IClienteDAO {
    ...
    private final String cadena_conexionDB = "jdbc:mysql://localhost:3306/DBUNIT?useSSL=false"; // en código tienes que especificar el schema usado "DBUNIT"
    
    static {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");  // este es el driver para la conexion con la bbd
